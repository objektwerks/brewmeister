...
final case class Grain(typeof: String = "", amount: Int = 0, mixinStep: MixinStep = MixinStep.Mashing)

final case class Hop(typeof: String = "", amount: Int = 0, mixinStep: MixinStep = MixinStep.Boiling) // or Whirlpooling or Conditioning

final case class Adjunct(typeof: String = "", amount: Int = 0, mixinStep: MixinStep = MixinStep.Mashing) // or Boiling or Conditioning

final case class Yeast(typeof: String = "", amount: Int = 0, mixinStep: MixinStep = MixinStep.Fermenting)
