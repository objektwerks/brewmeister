...
final case class Recipe(name: String,
                        ...
                        pH: Double = 5.0,
                        originalGravityRange: DoubleRange = DoubleRange(1.000, 2.000),
                        finalGravityRange: DoubleRange = DoubleRange(1.000, 2.000),
                        srmColorRange: IntRange = IntRange(6, 12),
                        ibuBitternessRange: IntRange = IntRange(60, 75),
                        alcoholByVolumeRange: DoubleRange = DoubleRange(2.0, 13.0),
                        alcoholByWeightRange: DoubleRange = DoubleRange(2.0, 13.0),
