...
final case class Recipe(name: String,
                        ...
                        pH: Double = 1.0,
                        originalGravityRange: DoubleRange = DoubleRange(1.0, 2.0),
                        finalGravityRange: DoubleRange = DoubleRange(1.0, 2.0),
                        srmColorRange: IntRange = IntRange(1, 1),
                        ibuBitternessRange: IntRange = IntRange(1, 2),
                        alcoholByVolumeRange: DoubleRange = DoubleRange(1.0, 2.0),
                        alcoholByWeightRange: DoubleRange = DoubleRange(1.0, 2.0),
                        calorieRange: IntRange = IntRange(1, 2),
                        mashEfficiencyRange: IntRange = IntRange(1, 2),
                        brewhouseEfficiencyRange: IntRange = IntRange(1, 2),
