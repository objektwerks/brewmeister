...
object Recipe:
  def default: Recipe =
    Recipe(name = "Objektwerks IPA",
           ...
           grains = Array( Grain("pale ale", 4.0, UoM.lb, 6.0, 1.8, 0) ),
           hops = Array( Hop("chinook", 2.0, 10.0, UoM.oz, 13.0, 30) ),
           adjuncts = Array.empty[Adjunct],
           yeasts = Array( Yeast("Wyeast American Ale 1056", 5.0, UoM.oz, 0) ),
...
final case class Recipe(name: String = "",
                        ...
                        grains: Array[Grain] = Array.empty[Grain],
                        hops: Array[Hop] = Array.empty[Hop],
                        adjuncts: Array[Adjunct] = Array.empty[Adjunct],
                        yeasts: Array[Yeast] = Array.empty[Yeast],
