...
final class Context(config: Config):
  ...
  val labelSanitizingStarted = config.getString("label.sanitizeStarted")
  val labelSanitizingCompleted = config.getString("label.sanitizeCompleted")
  val labelPreparingStarted = config.getString("label.prepareStarted")
  val labelPreparingCompleted = config.getString("label.prepareCompleted")
  val labelMaltingStarted = config.getString("label.maltStarted")
  val labelMaltingCompleted = config.getString("label.maltCompleted")
  val labelMillingStarted = config.getString("label.millStarted")
  val labelMillingCompleted = config.getString("label.millCompleted")
  val labelMashingStarted = config.getString("label.mashStarted")
  val labelMashingCompleted = config.getString("label.mashCompleted")
  val labelLauteringStarted = config.getString("label.lauterStarted")
  val labelLauteringCompleted = config.getString("label.lauterCompleted")
  val labelSpargingStarted = config.getString("label.spargeStarted")
  val labelSpargingCompleted = config.getString("label.spargeCompleted")
  val labelBoilingStarted = config.getString("label.boilStarted")
  val labelBoilingCompleted = config.getString("label.boilCompleted")
  val labelCoolingStarted = config.getString("label.coolStarted")
  val labelCoolingCompleted = config.getString("label.coolCompleted")
  val labelWhirlpoolingStarted = config.getString("label.whirlpoolStarted")
  val labelWhirlpoolingCompleted = config.getString("label.whirlpoolCompleted")
  val labelFermentingStarted = config.getString("label.fermentStarted")
  val labelFermentingCompleted = config.getString("label.fermentCompleted")
  val labelConditioningStarted = config.getString("label.conditionStarted")
  val labelConditioningCompleted = config.getString("label.conditionCompleted")
  val labelKeggingStarted = config.getString("label.kegStarted")
  val labelKeggingCompleted = config.getString("label.kegCompleted")
