...
final case class TimeDuration(time: Int, duration: Int, unit: UoT) derives JsonSupport
...
object Recipe:
  def default: Recipe =
    Recipe(created = now(),
           ...
           boilingDuration = 60,
           coolingTemp = (68, 72),
           fermentatingTemp = (68, 72),
           fermentingDuration = 2,
           conditioningTemp = (68, 72),
           conditioningDuration = 2,
           packagingTemp = (42, 45),
           packagingDuration = 2,
           pH = 5.6,
...
final case class Recipe(created: String = now(),
                        ...
                        conditioningDuration: Int,
                        packagingTemp: (Int, Int),
                        packagingDuration: Int,
                        pH: Double,
