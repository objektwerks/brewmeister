...
object Recipe:
  def default: Recipe =
    Recipe(created = now(),
           ...
           water = "spring",
           gallons = 5.0,
           mashingTempDuration = TempDuration( (148, 152), 60, UoT.minutes ),
           boilingTempDuration = TempDuration( (148, 152), 60, UoT.minutes ),
           coolingTemp = (68, 72),
           fermentatingTempDuration = TempDuration( (68, 72), 2, UoT.weeks ),
           conditioningTempDuration = TempDuration( (68, 72), 2, UoT.days ),
           packagingTempDuration = TempDuration( (42, 45), 2, UoT.days ),
           refrigerateTemp = (42, 45),
           pH = 5.6,
