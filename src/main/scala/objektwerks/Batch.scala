...
final case class Batch(recipe: String = "",
  ...
  val nameProperty = ObjectProperty(this, "name", s"$recipe.$completed")
  val recipeProperty = ObjectProperty(this, "recipe", recipe)
  val styleProperty = ObjectProperty(this, "style", style)
  val volumeProperty = ObjectProperty(this, "volume", volume)
  val mashingTempProperty = ObjectProperty(this, "mashingTemp", mashingTemp)
  val phProperty = ObjectProperty(this, "pH", pH)
  val boilingTempProperty = ObjectProperty(this, "boilingTemp", boilingTemp)
  val coolingTempProperty = ObjectProperty(this, "coolingTemp", coolingTemp)
  val mashEfficiencyProperty = ObjectProperty(this, "mashEfficiency", mashEfficiency)
  val originalGravityProperty = ObjectProperty(this, "originalGravity", originalGravity)
  val fermentingTempProperty = ObjectProperty(this, "fermentingTemp", fermentingTemp)
  val finalGravityProperty = ObjectProperty(this, "finalGravity", finalGravity)
  val conditioningTempProperty = ObjectProperty(this, "conditioningTemp", conditioningTemp)
  val srmColorProperty = ObjectProperty(this, "srmColor", srmColor)
  val ibuBitternessProperty = ObjectProperty(this, "ibuBitterness", ibuBitterness)
  val alcoholByVolumeProperty = ObjectProperty(this, "alcoholByVolume", alcoholByVolume)
  val alcoholByWeightProperty = ObjectProperty(this, "alcoholByWeight", alcoholByWeight)
  val caloriesProperty = ObjectProperty(this, "calories", calories)
  val keggingTempProperty = ObjectProperty(this, "keggingTemp", keggingTemp)
  val brewhouseEfficiencyProperty = ObjectProperty(this, "brewhouseEfficiency", brewhouseEfficiency)
  val appearanceProperty = ObjectProperty(this, "appearance", appearance)
  val aromaProperty = ObjectProperty(this, "aroma", aroma)
  val tasteProperty = ObjectProperty(this, "taste", taste)
  val logProperty = ObjectProperty(this, "log", log)
  val startedProperty = ObjectProperty(this, "started", started)
  val processProperty = ObjectProperty[Process](this, "process", process)
  val completedProperty = ObjectProperty(this, "completed", completed)
  val batch = this
