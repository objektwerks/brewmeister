...
final case class Process(sanitizingStarted: String = "",
  ...
  val conditioningStartedProperty = ObjectProperty[String](this, "conditioningStarted", conditioningStarted)
  val conditioningCompletedProperty = ObjectProperty[String](this, "conditioningCompleted", conditioningCompleted)
