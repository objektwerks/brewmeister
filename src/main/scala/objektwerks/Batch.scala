...
final case class Process(sanitizeStarted: String = "",
  ...
  val millStartedProperty = ObjectProperty[String](this, "millStarted", millStarted)
  val millCompletedProperty = ObjectProperty[String](this, "millCompleted", millCompleted) 
  val mashStartedProperty = ObjectProperty[String](this, "mashStarted", mashStarted)
  ...
  val boilStartedProperty = ObjectProperty[String](this, "boilStarted", boilStarted)
  val boilCompletedProperty = ObjectProperty[String](this, "boilCompleted", boilCompleted)
  val coolStartedProperty = ObjectProperty[String](this, "coolStarted", coolStarted)
  val coolCompletedProperty = ObjectProperty[String](this, "coolCompleted", coolCompleted)
  val whirlpoolStartedProperty = ObjectProperty[String](this, "whirlpoolStarted", whirlpoolStarted)
