...
final case class Lautering(log: List[String], started: String) extends Event
final case class Lautered(log: List[String], completed: String) extends Event

final case class Sparging(log: List[String], started: String) extends Event
final case class Sparged(log: List[String], completed: String) extends Event

final case class MashEfficiencyLogged(mashEfficiency: Int,
                                      log: List[String]) extends Event

final case class Boiling(log: List[String], started: String) extends Event
final case class Boiled(log: List[String], completed: String) extends Event

final case class Cooling(log: List[String], started: String) extends Event
final case class Cooled(log: List[String], completed: String) extends Event

final case class Whirlpooling(log: List[String], started: String) extends Event
final case class Whirlpooled(log: List[String], completed: String) extends Event
...
final case class Conditioning(log: List[String], started: String) extends Event
