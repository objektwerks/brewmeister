...
if (OS == "mac") assemblyJarName := "brewmeister-mac-0.16.jar"
else if (OS == "mac-aarch64") assemblyJarName := "brewmeister-m1-0.16.jar"
else if (OS == "win") assemblyJarName := "brewmeister-win-0.16.jar"
else if (OS == "linux") assemblyJarName := "brewmeister-linux-0.16.jar"
else assemblyJarName := "brewmeister-no-valid-target-specified-0.16.jar"
