...
* **Users**: java -jar .assembly/brewmeister-mac-0.86.jar ( See the **Assembly** and **Execute** sections below. )
...
* java -jar .assembly/brewmeister-mac-0.86.jar
* java -jar .assembly/brewmeister-m1-0.86.jar
* java -jar .assembly/brewmeister-win-0.86.jar
* java -jar .assembly/brewmeister-linux-0.86.jar
