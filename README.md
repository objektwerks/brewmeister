Brewmeister
-----------
>A beer brewing simulator, using ScalaFx, ControlsFx, uPickle, Os-Lib, Ox and Scala 3, that allows a brewer
>to **build** recipes and **brew** batches using the classic beer brewing process of sanitizing, preparing,
>malting, milling, mashing, lautering, sparging, boiling, cooling, whirlpooling, fermenting, conditioning
>and kegging.
...
* **Users**: java -jar .assembly/brewmeister-mac-1.02.jar ( See the **Assembly** and **Execute** sections below. )
...
>[Recipe](https://github.com/objektwerks/brewmeister/blob/main/src/main/scala/objektwerks/Recipe.scala) for details.
...
* java -jar .assembly/brewmeister-mac-1.02.jar
* java -jar .assembly/brewmeister-m1-1.02.jar
* java -jar .assembly/brewmeister-win-1.02.jar
* java -jar .assembly/brewmeister-linux-1.02.jar
