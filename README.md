...
* java -jar .assembly/brewmeister-mac-0.76.jar
* java -jar .assembly/brewmeister-m1-0.76.jar
* java -jar .assembly/brewmeister-win-0.76.jar
* java -jar .assembly/brewmeister-linux-0.76.jar
