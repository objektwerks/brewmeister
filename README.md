...
* java -jar .assembly/brewmeister-mac-0.67.jar
* java -jar .assembly/brewmeister-m1-0.67.jar
* java -jar .assembly/brewmeister-win-0.67.jar
* java -jar .assembly/brewmeister-linux-0.67.jar
