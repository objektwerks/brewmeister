...
11. **Fermenting** - **Transfer** the ***wort*** to the primary ***fermenter***. Then **pitch** the ***yeast*** into the ***wort***, allowing for the conversion of sugars into alcohol and CO2. Let ferment for 2+ weeks at required temperature (68 - 72F).
    1. input - wort, ***yeast***
    2. output - wort, ***final gravity***
12. **Conditioning** - **Optionally** **transfer** ***wort*** to a secondary ***fermenter***. Let condition for 2+ days at required temperature.
