...
* java -jar .assembly/brewmeister-mac-0.49.jar
* java -jar .assembly/brewmeister-m1-0.49.jar
* java -jar .assembly/brewmeister-win-0.49.jar
* java -jar .assembly/brewmeister-linux-0.49.jar
