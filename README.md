...
* java -jar .assembly/brewmeister-mac-0.69.jar
* java -jar .assembly/brewmeister-m1-0.69.jar
* java -jar .assembly/brewmeister-win-0.69.jar
* java -jar .assembly/brewmeister-linux-0.69.jar
