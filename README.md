...
* java -jar .assembly/brewmeister-mac-0.56.jar
* java -jar .assembly/brewmeister-m1-0.56.jar
* java -jar .assembly/brewmeister-win-0.56.jar
* java -jar .assembly/brewmeister-linux-0.56.jar
