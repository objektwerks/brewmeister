...
5. **Mashing** - **Transfer** the ***grist*** to a ***mash tun*** and bring to boil (148 - 158F). Then stir and let set for 60m, converting starches into fermentable sugars - known as the ***wort***.
