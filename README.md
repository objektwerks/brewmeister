...
* Select **remove** to delete a recipe or batch.
...
* java -jar .assembly/brewmeister-mac-0.83.jar
* java -jar .assembly/brewmeister-m1-0.83.jar
* java -jar .assembly/brewmeister-win-0.83.jar
* java -jar .assembly/brewmeister-linux-0.83.jar
