...
Flows
-----
>Invokes the entire brewing process in a single call.
...
1. java -jar .assembly/brewmeister-mac-0.7.jar
2. java -jar .assembly/brewmeister-m1-0.7.jar
3. java -jar .assembly/brewmeister-win-0.7.jar
4. java -jar .assembly/brewmeister-linux-0.7.jar
...
* [More Wayy to Get Hoppy](https://beerandbrewing.com/learning-lab-more-ways-to-get-hoppy/)
