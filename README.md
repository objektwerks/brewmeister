...
* java -jar .assembly/brewmeister-mac-1.03.jar
* java -jar .assembly/brewmeister-m1-1.03.jar
* java -jar .assembly/brewmeister-win-1.03.jar
* java -jar .assembly/brewmeister-linux-1.03.jar
