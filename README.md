...
* java -jar .assembly/brewmeister-mac-0.46.jar
* java -jar .assembly/brewmeister-m1-0.46.jar
* java -jar .assembly/brewmeister-win-0.46.jar
* java -jar .assembly/brewmeister-linux-0.46.jar
