...
11. **Fermenting** - **Transfer** the ***wort*** to a ***fermenter***. Then **pitch** the ***yeast*** into the ***wort***, allowing for the conversion of sugars into alcohol and CO2. Let ferment for 2 weeks. Optionally **transfer** to secondary fermenter and add ***hops***.
...
>Some beer recipes might require minor adjustments to this process.
