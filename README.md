...
* java -jar .assembly/brewmeister-mac-0.68.jar
* java -jar .assembly/brewmeister-m1-0.68.jar
* java -jar .assembly/brewmeister-win-0.68.jar
* java -jar .assembly/brewmeister-linux-0.68.jar
