Brewmeister
-----------
>Beer brewing simulator using ScalaFx, ControlsFx, uPickle, Os-Lib, Ox and Scala 3, allowing a brewer to build
...
3. **simulate** the 13-step brewing process to build a beer batch
