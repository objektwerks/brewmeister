...
* java -jar .assembly/brewmeister-mac-0.61.jar
* java -jar .assembly/brewmeister-m1-0.61.jar
* java -jar .assembly/brewmeister-win-0.61.jar
* java -jar .assembly/brewmeister-linux-0.61.jar
