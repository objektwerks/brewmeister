...
* java -jar .assembly/brewmeister-mac-0.47.jar
* java -jar .assembly/brewmeister-m1-0.47.jar
* java -jar .assembly/brewmeister-win-0.47.jar
* java -jar .assembly/brewmeister-linux-0.47.jar
