Brewmeister
-----------
>Brewing process simulation using ScalaFx, Ox, uPickle and Scala 3.

Todo
----
* Persistence
* App
* Include *temperature* in **Batch** for: mashing, boiling, cooling, fermentation, conditioning and kegging?
...
1. java -jar .assembly/brewmeister-mac-0.28.jar
2. java -jar .assembly/brewmeister-m1-0.28.jar
3. java -jar .assembly/brewmeister-win-0.28.jar
4. java -jar .assembly/brewmeister-linux-0.28.jar
