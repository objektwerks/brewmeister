...
1. java -jar .assembly/brewmeister-mac-0.8.jar
2. java -jar .assembly/brewmeister-m1-0.8.jar
3. java -jar .assembly/brewmeister-win-0.8.jar
4. java -jar .assembly/brewmeister-linux-0.8.jar
